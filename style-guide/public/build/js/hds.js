  ...
  $(document).ready(function () {
    ...
    health.tooltip = function(selector, options) {
      if (typeof tippy !== 'undefined') {
        ...
        console.log('Tooltip library has not been loaded.');
      }
    }
