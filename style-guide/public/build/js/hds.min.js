...
health=health||{};!function(t,e,n){var o={closeButton:!1,html:null,postProcess:function(){},triggerOn:"focus mouseenter touchstart",triggerOff:"blur mouseleave touchend"};t(n).ready(function(){var n=t("#health-tooltip");if(0!==n.length){var a,i,l,r=n.find(".health-tooltip__content"),c=function(t,e){!1===l&&(e.removeClass("health-tooltip--active"),t.removeAttr("aria-describedby"),t.attr("aria-expanded","false"),e.removeAttr("id"),e.detach(),r.html(""),a())};health.tooltip=function(s){var u=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};if("object"===_typeof(e)){var d=t(s);u=function(t){var e={};for(var n in o){var a;e[n]=null!==(a=t[n])&&void 0!==a?a:o[n]}return e}(u),l=!1,d.each(function(o,s){var d,p,f=t(s);a=function(){};var h=null!==(d=null!==(p=u.html)&&void 0!==p?p:f.attr("title"))&&void 0!==d?d:"";f.attr("title")&&f.removeAttr("title"),f.attr("data-health-tooltip",h),f.attr("data-health-tooltip-id","".concat(o)),f.attr("aria-expanded","false"),f.attr("aria-controls","health-tooltip-".concat(f.attr("data-health-tooltip-id"))),f.on(u.triggerOn,function(){clearTimeout(i),l=!0,function(n,o){var s=arguments.length>2&&void 0!==arguments[2]&&arguments[2];if(clearTimeout(i),l=!0,n.after(o),r.html(n.attr("data-health-tooltip")),!0===s){var u=t('<button class="health-tooltip__close" type="button" aria-label="Close tooltip"><span class="health-tooltip__icon health-tooltip__icon--close">&plus;</span></button>');u.on("click touchstart",function(){l=!1,c(n,o)}),r.append(u)}o.attr("id","health-tooltip-".concat(n.attr("data-health-tooltip-id"))),n.attr("aria-describedby","health-tooltip-".concat(n.attr("data-health-tooltip-id"))),a=e.autoUpdate(n[0],o[0],function(){e.computePosition(n[0],o[0],{strategy:"absolute",middleware:[e.offset(8),e.shift(),e.flip()]}).then(function(t){var e=t.x,n=t.y;Object.assign(o.css({left:"".concat(e,"px"),top:"".concat(n,"px")}))})}),!1===o.hasClass("health-tooltip--active")&&o.addClass("health-tooltip--active"),n.attr("aria-expanded","true")}(f,n,u.closeButton)}),!1===u.closeButton&&f.on(u.triggerOff,function(){l=!1,i=setTimeout(function(){c(f,n)},600)}),n.on("focus mouseenter touchstart",function(){clearTimeout(i),l=!0}),!1===u.closeButton&&n.on("blur mouseleave touchend",function(){l=!1,i=setTimeout(function(){c(f,n)},600)})})}u.postProcess&&"function"==typeof u.postProcess&&u.postProcess()}}})}(jQuery,window.FloatingUIDOM,document),function(t){t(document).ready(function(){t(".health-video__preview__link").click(function(e){e.preventDefault();var n="https://www.youtube.com/embed/"+t(this).attr("data-youtubeid")+"?autoplay=1&autohide=2&border=0&wmode=opaque&rel=0&html5=1&fs=1";t(this).data("params")&&(n+="&"+t(this).data("params"));var o=t('<div class="au-responsive-media-vid au-responsive-media-vid--16x9"></div>'),a=t("<iframe/>",{title:"YouTube video player",id:"youtube-iframe",class:"au-responsive-media-vid__item",allowfullscreen:"allowfullscreen",frameborder:"0","aria-live":"assertive",src:n});o.append(a),t(this).parent(".health-video__preview").replaceWith(o),t(".health-video__preview__length").hide()})})}(jQuery);