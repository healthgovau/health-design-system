...
health=health||{};!function(t,e,n){var o={closeButton:!1,html:null,postProcess:function(){},triggerOn:"focus mouseenter touchstart",triggerOff:"blur mouseleave touchend"};t(n).ready(function(){var n=t("#health-tooltip");if(0!==n.length){var a,i,l,r,c=n.find(".health-tooltip__content"),s=function(t,e){!1===r&&(e.removeClass("health-tooltip--active"),t.removeAttr("aria-describedby"),t.attr("aria-expanded","false"),e.removeAttr("id"),e.detach(),c.html(""),i&&i.remove(),c.hasClass("health-tooltip__content--close-button")&&c.removeClass("health-tooltip__content--close-button"),a())};health.tooltip=function(u){var d=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};if("object"===_typeof(e)){var p=t(u);d=function(t){var e={};for(var n in o){var a;e[n]=null!==(a=t[n])&&void 0!==a?a:o[n]}return e}(d),r=!1,p.each(function(o,u){var p,h,f=t(u);a=function(){};var m=null!==(p=null!==(h=d.html)&&void 0!==h?h:f.attr("title"))&&void 0!==p?p:"";f.attr("title")&&f.removeAttr("title"),f.attr("data-health-tooltip",m),f.attr("data-health-tooltip-id","".concat(o)),f.attr("aria-expanded","false"),f.attr("aria-controls","health-tooltip-".concat(f.attr("data-health-tooltip-id"))),f.on(d.triggerOn,function(){clearTimeout(l),r=!0,function(n,o){var u=arguments.length>2&&void 0!==arguments[2]&&arguments[2];clearTimeout(l),r=!0,n.after(o),i&&i.remove(),c.html(n.attr("data-health-tooltip")),!0===u&&(i=t('<button class="health-tooltip__close" type="button" aria-label="Close tooltip" tabindex="0"><span class="health-tooltip__icon health-tooltip__icon--close">&plus;</span></button>'),!1===c.hasClass("health-tooltip__content--close-button")&&c.addClass("health-tooltip__content--close-button"),i.on("click touchstart",function(){r=!1,s(n,o)}),c.after(i)),o.attr("id","health-tooltip-".concat(n.attr("data-health-tooltip-id"))),n.attr("aria-describedby","health-tooltip-".concat(n.attr("data-health-tooltip-id"))),a=e.autoUpdate(n[0],o[0],function(){e.computePosition(n[0],o[0],{strategy:"absolute",middleware:[e.offset(8),e.shift(),e.flip()]}).then(function(t){var e=t.x,n=t.y;Object.assign(o.css({left:"".concat(e,"px"),top:"".concat(n,"px")}))})}),!1===o.hasClass("health-tooltip--active")&&o.addClass("health-tooltip--active"),n.attr("aria-expanded","true")}(f,n,d.closeButton)}),!1===d.closeButton&&f.on(d.triggerOff,function(){r=!1,l=setTimeout(function(){s(f,n)},600)}),!1===d.closeButton&&(n.on("focus mouseenter touchstart",function(){clearTimeout(l),r=!0}),n.on("blur mouseleave touchend",function(){r=!1,l=setTimeout(function(){s(f,n)},600)}))})}d.postProcess&&"function"==typeof d.postProcess&&d.postProcess()}}})}(jQuery,window.FloatingUIDOM,document),function(t){t(document).ready(function(){t(".health-video__preview__link").click(function(e){e.preventDefault();var n="https://www.youtube.com/embed/"+t(this).attr("data-youtubeid")+"?autoplay=1&autohide=2&border=0&wmode=opaque&rel=0&html5=1&fs=1";t(this).data("params")&&(n+="&"+t(this).data("params"));var o=t('<div class="au-responsive-media-vid au-responsive-media-vid--16x9"></div>'),a=t("<iframe/>",{title:"YouTube video player",id:"youtube-iframe",class:"au-responsive-media-vid__item",allowfullscreen:"allowfullscreen",frameborder:"0","aria-live":"assertive",src:n});o.append(a),t(this).parent(".health-video__preview").replaceWith(o),t(".health-video__preview__length").hide()})})}(jQuery);